                    ...
                    <form action="{{ route('admin.promotions.update', $promotion) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('ten_khuyen_mai') is-invalid @enderror" 
                                   id="ten_khuyen_mai" name="ten_khuyen_mai" 
                                   value="{{ old('ten_khuyen_mai', $promotion->ten_khuyen_mai) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('mo_ta') is-invalid @enderror" 
                                      id="mo_ta" name="mo_ta" rows="3">{{ old('mo_ta', $promotion->mo_ta) }}</textarea>
                            @error('mo_ta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('phan_tram_giam') is-invalid @enderror" 
                                   id="phan_tram_giam" name="phan_tram_giam" 
                                   value="{{ old('phan_tram_giam', $promotion->phan_tram_giam) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('thoi_gian_bat_dau') is-invalid @enderror" 
                                   ...
                                   value="{{ old('thoi_gian_bat_dau', $promotion->thoi_gian_bat_dauFormat) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('thoi_gian_ket_thuc') is-invalid @enderror" 
                                   ...
                                   value="{{ old('thoi_gian_ket_thuc', $promotion->thoi_gian_ket_thucFormat) }}" required>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="trang_thai" name="trang_thai" 
                                       {{ old('trang_thai', $promotion->trang_thai) ? 'checked' : '' }}>
                                <label class="custom-control-label" for="trang_thai">Trạng thái hoạt động</label>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="chuyen_bay_ids[]" 
                                                           ...
                                                           {{ in_array($flight->id_chuyen_bay, old('chuyen_bay_ids', $selectedFlights)) ? 'checked' : '' }}>
                                                </td>
